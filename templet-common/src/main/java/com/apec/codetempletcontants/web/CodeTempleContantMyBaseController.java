 ...
 * @date 2017-10-30
 */
public class CodeTempleContantMyBaseController extends BaseController
{
    ...
    protected PageRequest genPageRequest(BaseDTO dto)
    {
        ...
        if(dto.getPageSize() > 0 && dto.getPageSize() < CodeTempletContantsContant.MAX_NUMBER_ONE_PAGE)
        {
