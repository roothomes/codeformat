...
/**
 * 类 编 号：BL_PU6030202_1000_keygen
...
@Component
public class KeyGenCodeTempletContants implements EnvironmentAware{
    ...
    public KeyGenCodeTempletContants()
    {
    ...
    public KeyGenCodeTempletContants(long workerId)
    {
        if(workerId > MAX_WORKER_ID || workerId < 0)
        {
            throw new IllegalArgumentException(
