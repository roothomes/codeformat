...
//        String basePath = "C:\\imgLogo\\";
//        String dirTime = DateFormatUtils.format(new Date(),DIR_FORMAT);
//
//        String srcImgPath = basePath + "src.png";
//        String iconPath = basePath + "logo.png";
//        String targerPath = basePath + "img_mark_icon.jpg";
//        String targerPath2 = basePath + "img_mark_icon_rotate.jpg";
//        // 给图片添加水印
